...
<head>
    <title>图书网</title>
     <link type="text/css" href="jspStudy/test6/css/booklist.css" rel="stylesheet"/>
</head>
 <body>
<%
...
<table style="float: left" width="30%">
 ...
 %>
    <tr>
        <th>
            <div class="pic" href="" target="_blank">
                --<img src='jspStudy/images/<%=book.getBookCover()%>'/>
            </div>
        </th>
        <th>
            <div class="desc">
    ...
    <div style="float: left"><a class="bn" href='jspStudy/test6/jsp/showCar.jsp'>查看购物车</a>
    </div>
 </body>