    ...
    <div class="container-fluid main-content">
        <div class="widget-container fluid-height clearfix mwi1200">
            ...
            <div class="widget-content padded clearfix">
                <form id="updateMenuFrom" class="form-horizontal" action="MenuServlet?method=updateMenu" method="post">
                    <input type="hidden" id="menuId" name="menuId" value="${updatemenu.menuId }"> 
